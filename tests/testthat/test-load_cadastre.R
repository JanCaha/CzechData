...
layers <- c("BODOVE_POLE_B", "BODOVE_POLE_T", "budovy body", "BUDOVY_DEF", "budovy",
            "DALSI_PRVKY_MAPY_B", "DALSI_PRVKY_MAPY_L", "DALSI_PRVKY_MAPY_T", "hranice parcel",
            "KATASTRALNI_UZEMI_DEF", "KATASTRALNI_UZEMI_L", "katastralni uzemi", "PARCELY_KN_B",
            "PARCELY_KN_DEF", "PARCELY_KN_L", "parcely", "PRVKY_ORIENT_MAPY_B", "PRVKY_ORIENT_MAPY_L",
            "PRVKY_ORIENT_MAPY_T", "VB_P")
